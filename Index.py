...
class SNP(wx.Frame):
    ...
    def DERE(self, event):
     os.system(r" python C:\Users\Karthik-Sekaran\Desktop\Thyroid-Github\1.Data-Encoding-and-Redundancy-Elimination.py")

    def MVTDB(self, event):
     os.system(r" python C:\Users\Karthik-Sekaran\Desktop\Thyroid-Github\2.Missing-Value-Treatment-and-Data-Balancing.py")

    def RRF(self, event):
     os.system(r" python C:\Users\Karthik-Sekaran\Desktop\Thyroid-Github\3.Removal-of-Redundant-Features.py")

    def CFSL2(self, event):
     os.system(r" python C:\Users\Karthik-Sekaran\Desktop\Thyroid-Github\4.CFS-L2-Regularization.py")

    def CAUROC(self, event):
        os.system(r" python C:\Users\Karthik-Sekaran\Desktop\Thyroid-Github\5.Classification-and-AUROC-visualization.py")
