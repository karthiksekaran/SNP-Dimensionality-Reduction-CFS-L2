...
array = read_csv("FCFB-Embedded.csv")
array.replace("Thyroid",1, inplace=True)
array.replace("Control",0, inplace=True)
array.to_csv("FCFB-Embedded-New.csv", index=False)
array = read_csv("FCFB-Embedded-New.csv").values
...
err = ((list[1]+list[2])/(list[0]+list[1]+list[2]+list[3]))
print("Error Rate:",err)
print("True Positive/Sensitivity/Recall:",list[0]/(list[0]+list[1]))
print("True Negative/Specificity:",list[3]/(list[3]+list[2]))
print("Positive Predictive Value/Precision:",list[0]/(list[0]+list[2]))
print("False Positive Rate:",list[2]/(list[2]+list[3]))
